...
if($name && $email && $phone && $message){
 ...
 $message_body="Formularz kontaktowy wysłany ze strony www.itgalkowski.pl\n";
 $message_body.="Imię i nazwisko: $name\n";
 $message_body.="Adres email: $email\n";
 $message_body.="Number: $phone\n";
 $message_body.="$message\n";
 if(mail("poczta@itgalkowski.pl","Formularz kontaktowy",$message_body,$headers)){
